...
from Queries import (
    ...
    QUERY_AGREGAR_MULTIPROPIETARIO, QUERY_OBTENER_ID_MULTIPROPIETARIOS_SQL, QUERY_ACTUALIZAR_MULTIPROPIETARIOS_POR_VIGENCIA,
    QUERY_ACTUALIZAR_TRANSFERENCIAS, QUERY_OBTENER_MULTIPROPIETARIOS_POR_COMMANPRED,
    QUERY_DELETE_MULTIPROPIETARIO, QUERY_SELECT_MULTIPROPIETARIOS_VIGENTES,
    ...
    QUERY_OBTENER_ULT_ANO_INSCRIPCION, OBTENER_MULTIPROPIETARIO_COMMANPRED_SQL, QUERY_OBTENER_MULTIPROPIETARIO_RUNURT_COMMANPRED__SQL,
